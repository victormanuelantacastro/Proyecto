...
<body>
    ...
    <!--Final cabecera-->
    <div class="container-fluid-sm mb-3 mx-5">
        ...
        <table id="tabla" class="row-sm-12" style="width:100%">
            ...
            <tbody>
                <?php while ($fila = $resultado->fetch_assoc()) {
                    if ($fila["dni_usuario"] == $_SESSION['dni']) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($fila["estado"] == 0) { ?>
                                    <a href="#" class="btn btn-warning">Aún no ha sido recibido
                            </td>
                        <?php } ?>
                        <?php if ($fila["estado"] == 1) { ?>
                            <a href="#" class="btn btn-danger">En preparación</td>
                            <?php } ?>
                            <?php if ($fila["estado"] == 2) { ?>
                                <a href="#" class="btn btn-warning">En camino</td>
                                <?php } ?>
                                <?php if ($fila["estado"] >= 3) { ?>
                                    <a href="#" class="btn btn-success">Finalizado</td>
                                    <?php } ?>
                        </tr>
                <?php }
                } ?>
