                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($fila["estado"] == 0) { ?>
                                    <a href="../controlador/cambiarEstadoPedido.php?id=<?php echo $fila['id'] ?>" class="btn btn-warning">Preparar
                            </td>
                        <?php } ?>
                        <?php if ($fila["estado"] == 1) { ?>
                            <a href="../controlador/cambiarEstadoPedido.php?id=<?php echo $fila['id'] ?>" class="btn btn-warning">Enviar</td>
                            <?php } ?>
                            <?php if ($fila["estado"] == 2) { ?>
                                <a href="../controlador/cambiarEstadoPedido.php?id=<?php echo $fila['id'] ?>" class="btn btn-warning">Entregar</td>
                                <?php } ?>
                                <?php if ($fila["estado"] == 3) { ?>
                                    <a href="../controlador/cambiarEstadoPedido.php?id=<?php echo $fila['id'] ?>" class="btn btn-warning">Finalizar</td>
                                    <?php } ?>
                            <td><a href="../controlador/pedidoCompleto.php?id=<?php echo $fila['id'] ?>" target="_blank" class="btn btn-info">Ver Productos</a></td>        
                        </tr>
                <?php }
                } ?>
