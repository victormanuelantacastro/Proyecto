...
<body>
    ...
    <div class="container p-5">
        <h1>El registro no ha podido ser realizado:</h1>
        <p>Existe la posibilidad de que el DNI , el email o usuario introducidos, ya se encuentren en nuestra base de datos</p>
        <p>Por favor, vuelva a intentarlo cambiando los datos anteriores, ¡Muchas gracias! <a href="registroUsuario.php">Intentar de nuevo</a></p>
