...
<body>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../images/fantalimon.jpg" class="d-block w-30" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../images/fantanaranja.jpg" class="d-block w-30" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../images/sprite.jpg" class="d-block w-30" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../images/sprite.jpg" class="d-block w-30" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../images/tinto.jpg" class="d-block w-30" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../images/cruzcampo.jpg" class="d-block w-30" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../images/cruzcamposin.jpg" class="d-block w-30" alt="...">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row text-center">
            <?php
            //get rows query
            $query = $conn->query("SELECT * FROM producto WHERE tipo='Bebida' ORDER BY id ASC LIMIT 30");
            if ($query->num_rows > 0) {
